    ...
    public static void main(String[] args) {
        ...
        switch(opcion){//Condicional de selección múltiple que permite realizar las distintas operaciones en cada caso según la opción del menú escogida.
            ...
            case 7:
                 ...
                 System.out.println("Introduce el IBAN de la cuenta");
                        iban = entrada.next();
                        //Condicional if que comprueba si se ha eliminado la cuenta. Si no existe la cuenta con el IBAN proporcionado imprime mensaje
                        //de que no ha sido posible eliminarla, en caso de que exista procede a borrarla con el método EliminarCuentaBancaria.
