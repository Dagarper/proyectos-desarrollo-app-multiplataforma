...
import java.time.Period;////Importamos clase de java que permite seleccionar un periodo de tiempo comprendido entre fechas. 


public class Vehiculo {//Clase pública Vehículo
    
    //Declaración de variables/atributos del objeto vehículo. Tipo private, solo serán visibles dentro de esta clase y de sus subclases(si las tuviera). 
...
private LocalDate fechaMatr;//Variable en formato fecha (dia/mes/año).
    ...
    public Vehiculo(String marca, String numMatricula, String nomProp, String descripcion, int numKm, double precio, LocalDate fechaMatr, String dniProp) {//Constructor vehículo.
...
//Método set de las variables/atributos del constructor. Permite asignar valores a las distintas variables/atributos del constructor. Son públicos para poder utilizarse
   ...
   //Método toString(), devuelve el nombre y el valor de las variables/atributos del constructor Vehículo.          
    ...
    public String toString() {
        return "Vehiculo{" + "marca=" + marca + ", numMatricula=" + numMatricula + ", nomProp=" + nomProp + ", dniProp=" + dniProp + ", descripcion=" + descripcion + ", numKm=" + numKm + ", precio=" + precio + ", fechaMatr=" + fechaMatr + '}';
    }
