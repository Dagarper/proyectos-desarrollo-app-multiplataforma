...
/**
 * Clase HiloServidor que extiende Thr ead para gestionar la solicitud de
 * archivos de un cliente.
 *
 * El hilo se encarga de recibir la ruta de un archivo desde el cliente,
 * verificar si el archivo existe y, en caso afirmativo, enviar su contenido. Si
 * el archivo no existe, notifica al cliente.
 */
public class HiloServidor extends Thread {
     ...
     *
     * Gestiona la interacción con el cliente: 1.Recibe la ruta de un archivo.
     * 2.Verifica si el archivo existe. 3.Si existe, lee y envía el contenido
     * del archivo. 4.Si no existe, informa al cliente.
     */
    @Override
    public void run() {
        ...
        try {
            ...
            out.writeUTF("Indique el usuario");
            String usuario = in.readUTF().trim();

            out.writeUTF("Indique la contraseña");
            String contraseña = in.readUTF().trim();

            if (usuario.equals("david") && contraseña.equals("secreta")) {
                ...
                while (!salir) {
                    ...
                    switch (comando) {
                        ...
                        case "get":
                            ...
                            File fichero = new File("./ficheros/" + ruta);
