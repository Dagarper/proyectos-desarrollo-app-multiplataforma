 ...
 *
 * El cliente se conecta al servidor en el puerto 1500, envía la ruta de un
 * archivo, y espera recibir su contenido si el archivo existe. Si no existe,
 * informa al usuario.
 */
public class Cliente {
     ...
     *
     * Se establece la conexión con el servidor, se envía la ruta del archivo
     * solicitada por el usuario, y se procesa la respuesta del servidor para
     * mostrar el contenido del archivo o un mensaje de error.
     */
